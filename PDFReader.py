...
clear_button = Button(frame_3, text = "Clear", command=lambda: text_box.delete('1.0',END),bg = "#d1c221")
...
read_button = Button(frame_2, text="Read aloud", command=read,bg = "#d1c221")
read_button.place(relx=0,rely=0,relwidth=0.25,relheight=1)

pause_button = Button(frame_2, text="Pause", command=pause,bg = "#d1c221")
pause_button.place(relx=0.25,rely=0,relwidth=0.25, relheight=1)

unpause_button = Button(frame_2, text="Unpause", command=unpause,bg = "#d1c221")
unpause_button.place(relx=0.5,rely=0,relwidth=0.25,relheight=1)

stop_button = Button(frame_2, text="Stop", command=stop,bg = "#d1c221")
stop_button.place(relx=0.75,rely=0,relwidth=0.25,relheight=1)

frame_4 = Frame(root, bg = "#660101", bd = 5)
frame_4.place(relx = 0.5, rely = 0.9, relwidth = 0.5, relheight = 0.1, anchor= "n")
label_3 = Label(frame_4, text = "Language",bg = "#d1c221")
